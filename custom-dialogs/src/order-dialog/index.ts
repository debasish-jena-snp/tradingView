import { PreOrder, IBrokerWithoutRealtime } from '../../../charting_library/broker-api';
...
export function showOrderDialog(customOrderDialog: HTMLElement, order: PreOrder): void {
