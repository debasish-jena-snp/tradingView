...
var UDFCompatibleDatafeedBase = /** @class */ (function () {
    function UDFCompatibleDatafeedBase(datafeedURL, quotesProvider, requester, updateFrequency) {
        ...
        this._configurationReadyPromise = this._requestConfiguration()
            ...
            configuration.symbols_grouping = {
                "futures": new RegExp('^(.+)([12]!|[ABCDEFGHJKMNQUVXZ]\d{1,2})$'),
                "Forex": new RegExp('^(.+)([12]!|[ABCDEFGHJKMNQUVXZ]\d{1,2})$')
            };
            configuration.futures_regex = /^(.+)([12]!|[ABCDEFGHJKMNQUVXZPLT]\d{1,2})$/;
